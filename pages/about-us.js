        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-pink">
            <div className="max-w-3xl mx-auto text-center ">
              ...
              <p className="text-lg md:text-xl text-gray-500 lg:mt-6 mt-2">
                Instaadvice provides a first-of-its-kind service to help you
                navigate the complex world of Instagram growth tools. Easily
                compare features, prices, and user feedback. We empower you to
                make informed choices, ensuring your business receives trusted
                guidance.
              </p>
            </div>
          ...
          <div className="sm:mt-20 mt-16">
            <div className="flex flex-col lg:flex-row gap-8">
              {/* Text Section */}
              <div className="w-full lg:w-1/2">
                <h2 className="md:text-5xl text-3xl font-semibold text-gray-800">
                  Who We Are?
                </h2>
                ...
                <p className="text-gray-500 text-lg md:text-xl mt-4">
                  Use our vast, easy-to-use, regularly updated database to find
                  the right Instagram growth service to fit your needs and
                  budget. Results are clear and easy – comparing prices, service
                  stakes, support options, features, and overall user scores.
                </p>
                <p className="text-gray-500 text-lg md:text-xl mt-4">
          ...
          <div className="sm:mt-20 mt-16  bg-gradient-pink">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-500 mt-6">
                We're a small, yet powerful team of social media experts,
                analysts, and experienced Instagram users. We're committed to
                providing clear, unbiased reviews of Instagram growth services
                to help you succeed.
              </p>
            </div>
            <motion.div
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:mt-16 mt-10 p-4"
