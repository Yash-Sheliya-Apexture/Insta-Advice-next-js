...
// // components/Advice/InstagramAdviceCardMain.js
// import React from "react";
// import { FaCheck } from "react-icons/fa6";
// import RatingDisplay from './RatingDisplay';
// import StarRating from '../StarRating/StarRating';
...
// const InstagramAdviceCardMain = ({ data, id, averageRating, totalReviews }) => {
...
//     }
//     const features = data.acf?.features?.split('\n') || [];
//     //const reviews = parseFloat(data.acf?.user_reviews) || 0; // No Longer Using
...
//                     </div>
//                     <div className="w-full h-full md:w-1/2 ">
//                         <RatingDisplay averageRating={averageRating} totalReviews={totalReviews} StarRating={StarRating} />
//                     </div>
//                 </div>
//             </div>
//             <div className="w-full lg:w-1/4 border-t-0 lg:border-l-2  border-gray-300 p-4 flex flex-col justify-center items-center">
