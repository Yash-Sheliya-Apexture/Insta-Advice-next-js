    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75" >
            ...
            >
               <button
                    onClick={handleClose}
                    className="absolute top-0 right-0 text-gray-950 focus:outline-none transition-colors duration-500 hover:bg-gray-950 hover:text-white rounded-full"
                    aria-label="Close"
                >
                    <FiX className="size-8  bg-white hover:bg-gray-950"/>
                </button>
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="w-full md:w-1/3 flex justify-center">
                        <Image
                            ...
                            style={{ // New style property
                              objectFit: "contain", // Equivalent of objectFit
