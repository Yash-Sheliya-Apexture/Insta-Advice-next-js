...
const OfferSection = () => {
  return (
    <section className="Banner text-white py-16 bg-gradient-to-r from-light-royal-blue from-0% via-purple-heart via-54% to-amaranth to-100% overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex lg:flex-row flex-col items-center gap-8 md:gap-16">
