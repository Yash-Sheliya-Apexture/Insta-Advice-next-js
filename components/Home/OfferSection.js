      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row rounded-xl">
          ...
          <div className="lg:w-1/2 text-left p-12 bg-gradient-to-r from-light-royal-blue from-0% via-purple-heart via-54% to-amaranth to-100% rounded-tl-xl rounded-tr-xl lg:rounded-tr-none lg:rounded-bl-xl text-white">
            ...
            <p className=" mt-6 text-lg">[ Website Name]'s reviews come from a dedicated team of Instagram growth fanatics: strategists, marketers, and tech experts. We exactly test and analyze the latest tools and techniques, going deep into each feature and its real-world value, as well as user feedback.</p>
            <p className=" mt-6 text-lg">We focus on cutting through the noise and providing the most accurate, reliable assessments. With a transparent approach, our platform empowers you to see the full scope of the growth service you are researching. We combine both our insights with real user feedback.</p>
            <p className=" mt-6 text-lg">Our goal is to help you confidently navigate Instagram's complexities. By combining our in-depth evaluations with real experiences, we are here to help you make the right choices and achieve your goals.</p>
            ...
            <div className="relative">
              <div className="relative">
                <img
                  ...
                  alt="Ethan Adams"
                  className="w-full h-[550px] object-cover object-center rounded-tr-none lg:rounded-tr-xl rounded-bl-xl lg:rounded-bl-none rounded-br-xl"
                  loading="lazy"
                />
              </div>
            </div>
