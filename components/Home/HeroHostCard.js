...
//   return (
//     <div className={`bg-white relative p-5 rounded-xl shadow-main-shadow transition-shadow duration-300 overflow-hidden flex flex-col justify-between min-h-[300px] ${isMiddleCard ? 'md:-mt-3 mt-0 md:mb-3 mb-0 lg:-mt-6 border-2 border-light-royal-blue' : ''}`}>
//       {/* Logo */}
